...
func TestDecodeSnapshotResponseRejectsInvalidEnvelope(t *testing.T) {
	...
	_, err = decodeSnapshotResponse([]byte(`{"schema_version":"arca.nms.telemetry-snapshot.v1","generated_at":"2026-05-15T12:34:56Z","resource":"/api/nms/v1/telemetry/snapshot","event_schema_version":"arca.telemetry.v1","encoding":"json","default_paths":["/system"],"default_sample_interval_ms":30000,"min_sample_interval_ms":1000,"max_sample_interval_ms":3600000,"paths":["/system"],"event_count":1,"payload_bytes":2,"events":[{"sequence":1,"timestamp":"2026-05-15T12:34:57Z","path":"/system","cardinality":"single","payload_schema":"arca.telemetry.system.v1","event_type":"snapshot","encoding":"json","schema_version":"arca.telemetry.v1","payload_bytes":2,"payload":{}}]}`))
	if err == nil || !strings.Contains(err.Error(), "generated_at") {
		t.Fatalf("decodeSnapshotResponse() error = %v, want event timestamp generated_at mismatch", err)
	}
	...
	_, err = decodeSnapshotResponse([]byte(`{"schema_version":"arca.nms.telemetry-snapshot.v1","resource":"/api/nms/v1/telemetry/snapshot","event_schema_version":"arca.telemetry.v1","encoding":"json","paths":["/system","/system"],"event_count":2,"payload_bytes":4,"events":[{"sequence":1,"timestamp":"2026-05-15T12:34:56Z","path":"/system","cardinality":"single","payload_schema":"arca.telemetry.system.v1","event_type":"snapshot","encoding":"json","schema_version":"arca.telemetry.v1","payload_bytes":2,"payload":{}},{"sequence":2,"timestamp":"2026-05-15T12:34:56Z","path":"/system","cardinality":"single","payload_schema":"arca.telemetry.system.v1","event_type":"snapshot","encoding":"json","schema_version":"arca.telemetry.v1","payload_bytes":2,"payload":{}}]}`))
	if err == nil || !strings.Contains(err.Error(), "duplicates") {
		t.Fatalf("decodeSnapshotResponse() error = %v, want duplicate emitted path mismatch", err)
	}
	...
	_, err = decodeSnapshotResponse([]byte(`{"schema_version":"arca.nms.telemetry-snapshot.v1","resource":"/api/nms/v1/telemetry/snapshot","event_schema_version":"arca.telemetry.v1","encoding":"json","paths":[],"event_count":0,"payload_bytes":0,"max_payload_bytes":-1,"events":[]}`))
	if err == nil || !strings.Contains(err.Error(), "max_payload_bytes") {
		t.Fatalf("decodeSnapshotResponse() error = %v, want max_payload_bytes negative mismatch", err)
	}
	_, err = decodeSnapshotResponse([]byte(`{"schema_version":"arca.nms.telemetry-snapshot.v1","resource":"/api/nms/v1/telemetry/snapshot","event_schema_version":"arca.telemetry.v1","encoding":"json","paths":[],"event_count":0,"payload_bytes":0,"max_payload_bytes":67108865,"events":[]}`))
	if err == nil || !strings.Contains(err.Error(), "max_payload_bytes") {
		t.Fatalf("decodeSnapshotResponse() error = %v, want max_payload_bytes cap mismatch", err)
	}
	...
	_, err = decodeSnapshotResponse([]byte(`{"schema_version":"arca.nms.telemetry-snapshot.v1","resource":"/api/nms/v1/telemetry/snapshot","event_schema_version":"arca.telemetry.v1","encoding":"json","paths":[],"event_count":0,"payload_bytes":0,"max_events":-1,"events":[]}`))
	if err == nil || !strings.Contains(err.Error(), "max_events") {
		t.Fatalf("decodeSnapshotResponse() error = %v, want max_events negative mismatch", err)
	}
	_, err = decodeSnapshotResponse([]byte(`{"schema_version":"arca.nms.telemetry-snapshot.v1","resource":"/api/nms/v1/telemetry/snapshot","event_schema_version":"arca.telemetry.v1","encoding":"json","paths":[],"event_count":0,"payload_bytes":0,"max_events":1025,"events":[]}`))
	if err == nil || !strings.Contains(err.Error(), "max_events") {
		t.Fatalf("decodeSnapshotResponse() error = %v, want max_events cap mismatch", err)
	}
	...
	_, err = decodeSnapshotResponse([]byte(`{"schema_version":"arca.nms.telemetry-snapshot.v1","resource":"/api/nms/v1/telemetry/snapshot","event_schema_version":"arca.telemetry.v1","encoding":"json","paths":[],"event_count":0,"payload_bytes":0,"timeout_ms":30001,"events":[]}`))
	if err == nil || !strings.Contains(err.Error(), "timeout_ms") {
		t.Fatalf("decodeSnapshotResponse() error = %v, want timeout_ms cap mismatch", err)
	}
