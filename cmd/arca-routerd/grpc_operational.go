...
func (s *grpcHAStatusSource) HAStatusInfo() nbgrpc.HAStatusInfo {
	...
	return nbgrpc.HAStatusInfo{
		...
		FRRBFDLastCheck:         metrics.FRRBFDLastRun,
		FRRBFDConfiguredPeers:   metrics.FRRBFDConfiguredPeers,
		FRRBFDObservedPeers:     metrics.FRRBFDObservedPeers,
		FRRBFDUpPeers:           metrics.FRRBFDUpPeers,
		FRRBFDDownPeers:         metrics.FRRBFDDownPeers,
		FRRBFDIssues:            append([]string(nil), metrics.FRRBFDIssues...),
		FRRBFDLastError:         metrics.FRRBFDError,
