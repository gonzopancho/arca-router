...
arca-router は現在 v0.7.x の core router parity フェーズです。この README は
...
- clustering、VRRP、MPLS、routing instances、QoS、IPv6 parity、BFD 向け v0.6/v0.7 設定基盤
...
├── internal/                   # v0.6.x/v0.7.x コアパッケージ
│   ├── model/                  # 正準的な設定 & 状態型
